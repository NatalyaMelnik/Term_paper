...
class VkUser:
    ...
    def get_photo(self, vk_id: str):
        ...
        необходимо пройти цикл для создания нужного списка словарей, требемый по заданию, в формате json-файла: [{"file_name": "34.jpg", "size": "z"}]'''
...
class YaDisk:
    def __init__(self):
        ...
        '''Следующий метод определяет заголовки в запросе'''
    ...
    def status_operation(self, href):
        ...
        while True:
            ...
            if response['status'] == 'success':  # операция успешно завершена
                ...
                'status'] == 'failed':  # операцию завершить не удалось, попробйте повторить изгачальный запрос копирования
                break
    ...
    def vk_fotos_upload(self, files: list, album: str = 'FOTOS'):
        ...
        количество лайков_дата загрузки'''
